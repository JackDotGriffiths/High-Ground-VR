...
public class PhysicalButton : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //Cannot use Rigidbody constraints as they operate in world space, This needs to operate in local space. This following if statement acts as an X and Z constraint.
